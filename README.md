...
**Toegankelijkheid**
De website is redelijk toegankelijk. De dropdowns kunnen geopend worden met het toetsenbord, alleen is er een klein contrast probleem bij de footer en de knoppen. Dit kan makkelijk opgelost worden door een ander contrast te gebruiken voor de kleuren. Verder kan je door de hele pagina heen tabben en is alles leesbaar met verschillende groottes tekst per scherm.
